    ...
    <div>
      ...
      <section className="bg-purple-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6" data-aos="fade-up">About Rare Teck</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold mb-6 text-gray-800" data-aos="fade-up">OUR MISSION & VISION</h2>
              <p className="text-gray-600 mb-4" data-aos="fade-up" data-aos-delay="200">At Rare Teck, our vision is to be a top provider of innovative and reliable software solutions that help businesses achieve their goals. We aim to create a future where technology makes life easier and where our software products have a positive impact on the world.</p>
              <p className="text-gray-600 mb-4" data-aos="fade-up" data-aos-delay="300">Our mission is to deliver high-quality software that meets and exceeds our clients’ expectations. We do this by using the latest technologies, hiring the best talent, and encouraging a culture of innovation, teamwork, and excellence. We aim to build long-term relationships with our clients based on trust and respect, providing them with the support they need to succeed in a fast-changing digital world.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-purple-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800" data-aos="fade-up">Our Values</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="200">
              These core principles guide our work and relationships with clients.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="zoom-in" data-aos-delay="300">
