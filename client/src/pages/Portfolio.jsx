      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto" data-aos="zoom-in" data-aos-delay="400">
            ...
            <TestimonialCard testimonial="I had the pleasure of working with Holly Caldwell for my logo and business cards and let me tell you, she is amazing and very easy to work with! I highly recommend Rare Teck and Holly! Thanks" name="Chris Kline" designation="Owner/CEO" />
