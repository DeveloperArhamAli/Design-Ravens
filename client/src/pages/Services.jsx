          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
            ...
            <div>
              <div className="bg-purple-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                <Monitor className="text-purple-600 w-8 h-8" />
              </div>
              ...
              <Link to="/contact" className="text-purple-600 font-medium hover:text-purple-800 transition-colors">
            ...
            <div>
              <div className="bg-purple-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                <PenTool className="text-purple-600 w-8 h-8" />
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative z-10">
                ...
                <div className="mb-16 flex flex-col md:flex-row items-center">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-purple-600 text-white font-bold mb-4 md:mb-0 z-10">
                    1
                  </div>
