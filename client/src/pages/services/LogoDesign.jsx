      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="zoom-in">
            ...
            <ServiceCard icon={<Palette className="text-purple-600 w-12 h-12 mb-4" />} heading="Branding Strategy" description="Creating a cohesive brand identity that aligns with your values and objectives." />

            <ServiceCard icon={<Rocket className="text-purple-600 w-12 h-12 mb-4" />} heading="Business Growth" description="Helping businesses stand out and build a foundation for long-term success." />
      ...
      <section className="py-20 bg-purple-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8" data-aos="zoom-in">
            ...
            <BenefitsOfWebDesignCard icon={<CheckCircle className="text-purple-600 w-6 h-6 flex-shrink-0" />} heading="Professional Image" description="A high-quality logo conveys professionalism and builds trust with your audience." />

            <BenefitsOfWebDesignCard icon={<CheckCircle className="text-purple-600 w-6 h-6 flex-shrink-0" />} heading="Brand Differentiation" description="A unique logo helps you stand out from competitors and creates a distinct identity." />

            <BenefitsOfWebDesignCard icon={<CheckCircle className="text-purple-600 w-6 h-6 flex-shrink-0" />} heading="Consistent Brand Identity" description="A well-designed logo serves as the foundation for a consistent brand identity across all touchpoints." />
