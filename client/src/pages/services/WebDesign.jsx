      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="zoom-in">
            ...
            <ServiceCard icon={<ShoppingCart className="text-purple-600 w-12 h-12 mb-4" />} heading="E-Commerce Solutions" description="Build seamless, high-performing online stores designed for smooth shopping experiences." />

            <ServiceCard icon={<Rocket className="text-purple-600 w-12 h-12 mb-4" />} heading="SEO-Optimized Websites" description="Our websites are built to rank higher on search engines, driving more traffic and growth." />
      ...
      <section className="py-20 bg-purple-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8" data-aos="zoom-in" data-aos-delay="300">
            ...
            <BenefitsOfWebDesignCard icon={<CheckCircle className="text-purple-600 w-6 h-6 flex-shrink-0" />} heading="Improved User Experience" description="Intuitive navigation and thoughtful design create a positive experience that keeps visitors engaged." />

            <BenefitsOfWebDesignCard icon={<CheckCircle className="text-purple-600 w-6 h-6 flex-shrink-0" />} heading="Higher Conversion Rates" description="Strategic design elements guide visitors toward desired actions, increasing conversion rates." />

            <BenefitsOfWebDesignCard icon={<CheckCircle className="text-purple-600 w-6 h-6 flex-shrink-0" />} heading="Better Search Engine Rankings" description="SEO-friendly design helps improve your visibility in search results, driving more organic traffic." />
